...
class WebExampleDocument {
    ...
    @NonNull public final List<String> layers;
    @NonNull public final List<String> tokens;

    public WebExampleDocument(@NonNull String id, @NonNull String title, @NonNull List<String> layers, @NonNull List<String> tokens) {
        this.id = id;
        this.title = title;
        this.layers = layers;
        this.tokens = tokens;
