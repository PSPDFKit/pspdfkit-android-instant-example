# Nutrient Android SDK — Instant example

This is a small example app demonstrating [Nutrient Android SDK](https://nutrient.io/sdk/android/) and [Nutrient Instant](https://nutrient.io/sdk/instant/). This example is the Android client counterpart of https://github.com/PSPDFKit/pspdfkit-server-example-rails.
